...
if tipo == "casa" or tipo == "apartamento":
  custo = float(input("Quanto você gasta de água em m3?."))
if (tipo == "casa" or tipo =="apartamento") and custo < 10.0:
  print("Consumo econômico - exelente controle de água.")
elif (tipo == "casa" or tipo =="apartamento") and 10.0 <= custo <= 25.0:
